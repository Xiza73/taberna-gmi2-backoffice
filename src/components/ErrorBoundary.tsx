...
/**
 * Error boundary global. Atrapa crashes de render en cualquier hijo y
 * muestra un fallback en lugar de pantalla blanca. Los errores de
 * eventos / promises NO los captura — esos se manejan en cada feature.
 */
