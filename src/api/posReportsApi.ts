...
export const posReportsApi = {
  ...
  byPaymentMethod(query: RangeReportQuery): Promise<PaymentMethodReportResponse> {
    return apiClient.get<PaymentMethodReportResponse>(
      '/admin/pos/reports/by-payment-method',
      { query },
    );
  },
  ...
  byStaff(query: RangeReportQuery): Promise<StaffSalesReportResponse> {
    return apiClient.get<StaffSalesReportResponse>('/admin/pos/reports/by-staff', {
      query,
    });
  },
};
